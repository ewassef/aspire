...
namespace Aspire.Hosting
{
    ...
    {
        public static void AddDockerComposePublisher(this IDistributedApplicationBuilder builder, System.Action<Docker.DockerComposePublisherOptions>? configureOptions = null) { }

        public static void AddDockerComposePublisher(this IDistributedApplicationBuilder builder, string name, System.Action<Docker.DockerComposePublisherOptions>? configureOptions = null) { }
    }
}
...
namespace Aspire.Hosting.Docker.Resources.ComposeNodes
{
    ...
    public sealed partial class Service : NamedComposeMember
    {
        ...
        public System.Collections.Generic.List<string> DependsOn { get { throw null; } set { } }
